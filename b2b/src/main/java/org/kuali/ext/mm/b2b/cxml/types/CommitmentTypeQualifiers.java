 ...
 *       &lt;sequence>
 *         &lt;element ref="{}CommitmentTypeQualifier" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "CommitmentTypeQualifiers")
public class CommitmentTypeQualifiers {

    @XmlElement(name = "CommitmentTypeQualifier")
    protected List<String> commitmentTypeQualifier;
     ...
     * 
     */
    public List<String> getCommitmentTypeQualifier() {
        if (commitmentTypeQualifier == null) {
            commitmentTypeQualifier = new ArrayList<String>();
        }
