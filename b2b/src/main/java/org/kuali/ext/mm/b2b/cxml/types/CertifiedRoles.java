 ...
 *       &lt;sequence>
 *         &lt;element ref="{}CertifiedRole" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "CertifiedRoles")
public class CertifiedRoles {

    @XmlElement(name = "CertifiedRole", required = true)
    protected List<CertifiedRole> certifiedRole;
     ...
     * 
     */
    public List<CertifiedRole> getCertifiedRole() {
        if (certifiedRole == null) {
            certifiedRole = new ArrayList<CertifiedRole>();
        }
